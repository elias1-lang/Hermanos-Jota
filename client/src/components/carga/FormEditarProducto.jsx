...
function FormEditarProducto({endpoint,productoData,categorias,cambiarEstadoModal,handleActualizaciones,tituloBoton="Editar Producto"}){
    ...
    const [formData,setFormData] = useState({
        ...
        terminacion: productoData?.terminacion || "",
        almacenamiento: productoData?.almacenamiento || "",
    ...
    const manejadorEnvio = (event) => {
        ...
        try {
            ...
            handleActualizaciones(formData,endpoint,IDProducto);
            ...
            <form className="carga-form" onSubmit={manejadorEnvio}>
                <fieldset>
                    ...
                    <FormImputText nameLabel={"Imagen del Producto"} nameCampo={"imageUrl"} onChange={manejadorCambios} tipo={"text"} value={formData.imageUrl}/>
                        {formData.imageUrl && <ComponentePrevisualizacionImagen imageUrl={formData.imageUrl}/>}
                    <div>
                ...
                <button type="submit" className="carga-submit">{tituloBoton}</button>
...
const ComponentePrevisualizacionImagen = ({imageUrl}) => {
    return(
        <div className="Previsualizacion_Imagen_Carga_DIV">
            <img src={imageUrl} alt="Imagen de Previsualizacion" onError={(e)=>{e.target.style.display = "none"}}/>
        </div>
    );
}